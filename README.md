alu_regex-data-extraction_mmuuse-dot
...
Project Files
Src (main.py) — Main Python script that performs the extraction.
input (input raw.txt) — Sample input file with unstructured data.
output (sampe output.json) — Sample input file with structured data.
README.md — Project overview and usage instructions.
How to Use
1.Make sure Python 3 is installed on your system.
2. Run the script:
python3 src/main.py
Place your raw text in sample_data.txt.
Run the script:
